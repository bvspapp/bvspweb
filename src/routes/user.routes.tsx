...
import AttendanceOptions from '../pages/UserScreens/Attendance/AttendanceOptions';
import AttendanceRegister from '../pages/UserScreens/Attendance/AttendanceRegister';
import MyRequests from '../pages/UserScreens/Attendance/MyRequests';
import RequestDetails from '../pages/UserScreens/Attendance/RequestDetails';
import ContactsOptions from '../pages/UserScreens/Attendance/ContactsOptions';
...
const UserRoutes: React.FC = () => (
  <AppLayoutUser>
    <Switch>
      ...
      <Route
        path="/attendance/:contact/:type"
        exact
        component={AttendanceRegister}
      />

      <Route path="/contacts-options/:type" exact component={ContactsOptions} />

      <Route path="/myrequests" exact component={MyRequests} />
      <Route path="/request/view/:id" exact component={RequestDetails} />
