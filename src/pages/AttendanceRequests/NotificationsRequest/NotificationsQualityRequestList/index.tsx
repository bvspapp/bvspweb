...
const NotificationsQualityRequestList: React.FC = () => {
  ...
  const handleFetchData = useCallback(async () => {
    setLoading(true);
    await api
      .get(`/requests/alert-byrequest-and-type/2/${selectDate}/${pageNumber}/8`)
      .then(response => {
        const date = new Date();
...
export default NotificationsQualityRequestList;
